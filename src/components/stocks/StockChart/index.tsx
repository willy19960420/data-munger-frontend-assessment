...
const formatRevenue = (value: number) => value.toLocaleString('zh-TW', { maximumFractionDigits: 0 });
...
export const StockChart = memo(({ stockMonthRevenue = [] }: StockChartProps) => {
    ...
    <div style={{ marginTop: '20px' }}>
      <Flex align="center" justify="space-between" style={{ marginBottom: '10px' }}>
        ...
        <Flex align="center" gap={12}>
          ...
          >
            <span style={{ width: '10px', height: '10px', background: '#f1c232', display: 'inline-block' }} />
          ...
          >
            <span style={{ width: '10px', height: '2px', background: '#d9534f', display: 'inline-block' }} />
